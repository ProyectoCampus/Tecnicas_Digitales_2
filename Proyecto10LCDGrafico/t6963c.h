...
// Prototipos de función de control del display
...
void GLCD_Bitmap(unsigned char * bitmap, unsigned char, unsigned char, unsigned char, unsigned char);
